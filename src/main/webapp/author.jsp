	...
	$(document)
			.ready(
					function() {
						$('#updateBtn').hide();
						$.ajax({
									url : 'http://localhost:8080/BookRentWebService/mytestapi/author/getAllAuthor',
									type : 'GET',
					...
					$('#addBtn').on('click', function(){
						...
						$(document).on("click",".edit",function() {
							...
							$('#updateBtn').show();
									...
									$('#updateBtn').on('click', function(){
										...
										$.ajax({
											url:'http://localhost:8080/BookRentWebService/mytestapi/author/updateAuthor,
											type: "POST",
											success:function(data){
												$('#exampleModal').modal('hide');
												$('#author_form')[0].reset();
						...
						$(document).on("click", ".delete", function() {
							...
							if (confirm('Are you sure you want to delete this record?')) {
								$.ajax({
									url: '.http://localhost:8080/BookRentWebService/mytestapi/author/deleteAuthor/'+id,
									type: 'Post',
